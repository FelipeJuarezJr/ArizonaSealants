...
if (isset($_POST['submit'])) {
    $mailto = "arizonasealants@yahoo.com"; // My email address *** UPDATE TO USE JOSE'S EMAIL ADDRESS ***
    ...
    $message2 = "Dear " . $name . "," . "\n"
    . "Thank you for contacting Arizona Sealants. We'll call or email you shortly!" . "\n\n"
    //. "You submitted the following message: " . "\n" . $_POST['message'] . "\n\n"
    . "-Best Regards," . " Arizona Sealants L.L.C.";
